...
// muted        console.log('patents.search() - searchURL = '+searchURL);
...
// muted                console.log(patents.data.list);
            }// muted else console.log('no patents FOUND!');
        }
